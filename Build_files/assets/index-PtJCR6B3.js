...
function D1() {
  ...
  function j(r, x, K) {
    ...
    if (
      ...
      K = {};
      for (var il in x) il !== "key" && (K[il] = x[il]);
    } else K = x;
    return (
      (x = K.ref),
      { $$typeof: O, type: r, key: k, ref: x !== void 0 ? x : null, props: K }
    );
  }
  return ((re.Fragment = Q), (re.jsx = j), (re.jsxs = j), re);
}
var kd;
function U1() {
...
function R1() {
  ...
  var tl = (V.prototype = new Zl());
  ((tl.constructor = V), Al(tl, zl.prototype), (tl.isPureReactComponent = !0));
  ...
  function xl(s, A, D, z, H) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case Q:
              ...
              break;
            case U:
              return ((G = s._init), xl(G(s._payload), A, D, z, H));
          }
      }
    if (G)
      return (
    ...
    if (bl(s))
      for (var yl = 0; yl < s.length; yl++)
        ((z = s[yl]), (F = Fl + Bl(z, yl)), (G += xl(z, A, D, F, H)));
    else if (((yl = P(s)), typeof yl == "function"))
      for (s = yl.call(s), yl = 0; !(z = s.next()).done; )
        ((z = z.value), (F = Fl + Bl(z, yl++)), (G += xl(z, A, D, F, H)));
    else if (F === "object") {
      if (typeof s.then == "function") return xl(ou(s), A, D, z, H);
      throw (
        (A = String(s)),
        Error(
      ...
      (function (O) {
        ...
        function bl(S) {
          for (var _ = j(E); _ !== null; ) {
            if (_.callback === null) r(E);
              ...
              (r(E), (_.sortIndex = _.expirationTime), Q(M, _));
            else break;
            _ = j(E);
          }
        }
        ...
        function Mt() {
          if (((zl = !1), Wl)) {
            ...
            try {
              l: {
                ((Al = !1), Yl && ((Yl = !1), V($l), ($l = -1)), (Ml = !0));
                var Y = P;
                try {
                  t: {
                    for (
                      bl(S), ul = j(M);
                      ul !== null && !(ul.expirationTime > S && qu());

                    ) {
                      var sl = ul.callback;
                      if (typeof sl == "function") {
                        ((ul.callback = null), (P = ul.priorityLevel));
                        var s = sl(ul.expirationTime <= S);
                        if (((S = O.unstable_now()), typeof s == "function")) {
                          ((ul.callback = s), bl(S), (_ = !0));
                          break t;
                        }
                        (ul === j(M) && r(M), bl(S));
                      } else r(M);
            ...
            return (
              ...
              Y > sl
                ? ((S.sortIndex = Y),
                  ...
                  j(M) === null &&
                    S === j(E) &&
                    (Yl ? (V($l), ($l = -1)) : (Yl = !0), xl(W, Y - sl)))
                : ((S.sortIndex = s),
                  Q(M, S),
                  Al || Ml || ((Al = !0), Wl || ((Wl = !0), Bl()))),
              S
            );
          }),
...
function p1() {
  ...
  return (
    ...
    (Xl.useFormState = function (M, E, U) {
...
` +
  ...
  function qa(l) {
    ...
    if (
      ...
      t === 27
        ...
        : (ml = Ql ? St(l.stateNode.nextSibling) : null);
    return !0;
  }
  function Ya() {
    ((ml = Ql = null), (ll = !1));
          ...
          l: {
            ...
            switch (p.tag) {
              ...
              case 0:
                if (
                  ((B = p.payload),
                  (o = typeof B == "function" ? B.call(cl, T, o) : B),
                  o == null)
                )
                  break l;
                T = U({}, T, o);
  ...
  function Ts(l) {
    ...
    if (((kt = 0), (Tl = nl = Z = null), (Je = !1), (La = 0), (ua = null), t))
      throw Error(r(300));
    l === null ||
      Ul ||
  ...
  function jf(l) {
    ...
    ((kt = 0), (Tl = nl = Z = null), (ta = !1), (La = we = 0), (ua = null));
  }
  function Kl() {
    var l = {
      memoizedState: null,
  ...
  function xs(l, t, u) {
    ...
    return (
      u !== t.memoizedState &&
        ((Z.flags |= 2048), aa(9, ke(), Ey.bind(null, e, u), null)),
      [a, n, l]
    );
  }
  function Ey(l, t) {
  ...
  function Jf(l, t, u) {
    return u === void 0 || (kt & 1073741824) !== 0
      ? (l.memoizedState = t)
      : ((l.memoizedState = u), (l = $0()), (Z.lanes |= l), (au |= l), u);
  }
  function ws(l, t, u, a) {
    return lt(u, t)
      ? u
  ...
  var Pe = {
    ...
    u0 = {
      ...
      useCacheRefresh: function () {
        return (Kl().memoizedState = zy.bind(null, Z));
      },
    },
    a0 = {
      readContext: jl,
  ...
  function n0(l) {
    ...
    function o(v, d, y, b) {
      ...
      if (typeof y == "object" && y !== null) {
        ...
        if (xl(y) || Bl(y)) return R !== null ? null : g(v, d, y, b, null);
    ...
    function m(v, d, y, b, R) {
      ...
      if (typeof b == "object" && b !== null) {
        ...
        if (b.$$typeof === tl) return m(v, d, y, Ce(d, b), R);
        tn(d, b);
      }
      return null;
    }
    function B(v, d, y, b) {
      for (
        var R = null, L = null, N = d, q = (d = 0), Nl = null;
        N !== null && q < y.length;
        q++
      ) {
    ...
    function p(v, d, y, b) {
      ...
      for (
        var R = null, L = null, N = d, q = (d = 0), Nl = null, I = y.next();
        N !== null && !I.done;
        q++, I = y.next()
      ) {
        N.index > q ? ((Nl = N), (N = null)) : (Nl = N.sibling);
      ...
      if (
        ...
        switch (y.$$typeof) {
          ...
          case Ml:
            ...
            return f(v);
          case kl:
            return ((R = y._init), (y = R(y._payload)), cl(v, d, y, b));
        }
        if (xl(y)) return B(v, d, y, b);
        if (Bl(y)) {
          if (((R = Bl(y)), typeof R != "function")) throw Error(r(150));
  ...
  function c0(l) {
    if (l.tag === 22) {
      if ((z(Ol, Ol.current), z(ht, l), At === null)) {
        var t = l.alternate;
  ...
  function It() {
    (z(Ol, Ol.current), z(ht, ht.current));
  }
  function Bt(l) {
    (D(ht), At === l && (At = null), D(Ol));
  }
  var Ol = A(0);
  function un(l) {
    for (var t = l; t !== null; ) {
  ...
  function D0(l, t, u) {
    var a = t.pendingProps,
      e = a.revealOrder,
      n = a.tail;
    if ((Hl(l, t, a.children, u), (a = Ol.current), (a & 2) !== 0))
      ((a = (a & 1) | 2), (t.flags |= 128));
    else {
        ...
        return (
          l === null &&
            ...
            ((l = u = ml) &&
              ...
              u !== null
                ? ((t.stateNode = u), (Ql = t), (ml = null), (l = !0))
                : (l = !1)),
            l || _u(t)),
          null
        );
  ...
  function Uy(l, t, u) {
    ...
    switch ((bf(t), t.tag)) {
      ...
      case 19:
        if ((D(Ol), (e = t.memoizedState), e === null)) return (ol(t), null);
  ...
  function ft(l, t, u) {
    (((l === vl && (el === 2 || el === 9)) || l.cancelPendingCommit !== null) &&
      ...
      ((al & 2) === 0 || l !== vl) &&
        (l === vl &&
          ((al & 2) === 0 && (Hu |= u), rl === 4 && fu(l, $, ot, !1)),
        Ot(l)));
  }
  function k0(l, t, u) {
    if ((al & 6) !== 0) throw Error(r(327));
        ...
        if (el !== 0 && J !== null) {
          ...
          switch (el) {
            ...
            case 6:
              ht.current === null && (t = !0);
              var h = el;
              if (((el = 0), (et = null), ha(l, c, i, h), u && ia)) {
                f = 0;
                break l;
              }
              break;
            default:
              ((h = el), (el = 0), (et = null), ha(l, c, i, h));
          }
        }
        (By(), (f = rl));
        break;
        ...
        if (el !== 0 && J !== null) {
          ...
          t: switch (el) {
            ...
            case 5:
              ...
              ((el = 0), (et = null), ha(l, t, n, 5));
              break;
            case 6:
              ((el = 0), (et = null), ha(l, t, n, 6));
              break;
            case 8:
              (Ec(), (rl = 6));
              break l;
  ...
  function ed(l, t, u, a, e, n, f, c, i) {
    ...
    if (t !== null) {
      ...
      if (
        ...
        ((a = S.T), (S.T = null), (e = _.p), (_.p = 2), (f = al), (al |= 4));
        try {
          Ny(l, t, u);
        } finally {
          ((al = f), (_.p = e), (S.T = a));
  ...
  function sd() {
    ...
    try {
      ...
      var n = nu,
        f = va;
      if (((pl = 0), (da = nu = null), (va = 0), (al & 6) !== 0))
        throw Error(r(331));
      var c = al;
      if (
        ((al |= 4),
...
var x1 = B1();
function G1({ id: O, type: Q, addTask: j }) {
  const [r, x] = Cl.useState("");
  function K(il) {
    x(il.target.value);
  }
  function k(il) {
    (il.preventDefault(), j(r), x(""));
  }
...
function j1({ val: O, isPressed: Q, setFilter: j }) {
...
function X1({
  ...
  const Yl = X.jsxs("form", {
      ...
      children: [
        X.jsx("div", {
          children: X.jsx(
            "input",
            { id: `edit-${Q}`, type: "text", value: U, onChange: Al, ref: k },
            Q,
          ),
        }),
        X.jsxs("div", {
  ...
  return (
    Cl.useEffect(() => {
      !Zl && M ? k.current.focus() : Zl && !M && il.current.focus();
    }, [Zl, M]),
    X.jsx(X.Fragment, { children: M ? Yl : zl })
  );
}
let Q1 = (O = 21) =>
  crypto
...
function C1() {
  ...
  function Q(V, tl) {
    const bl = k.map((W) => (V === W.id ? { ...W, name: tl } : W));
    il(bl);
  }
  function j(V) {
    const tl = k.filter((bl) => V !== bl.id);
    (M--, il(tl));
  }
  function r(V) {
    const tl = k.map((bl) =>
      V === bl.id ? { ...bl, isChecked: !bl.isChecked } : bl,
    );
    il(tl);
  }
  function x(V) {
    const tl = { id: `todo-${Q1()}`, name: V, isChecked: !1 };
    (il([...k, tl]), M++);
  }
  const K = [
  ...
  let M = k.length,
    E = "tasks";
  const [U, ul] = Cl.useState("All"),
    P = {
      All: () => !0,
      Active: (V) => !V.isChecked,
      Completed: (V) => V.isChecked,
    },
    Al = Object.keys(P).map((V) =>
      X.jsx(j1, { val: V, isPressed: V === U, setFilter: ul }, V),
    ),
    Yl = k.filter(P[U]);
  ((M = Yl.length), M == 1 && (E = "task"));
  const zl = Cl.useRef(null),
    Zl = O(M);
  return (
    Cl.useEffect(() => {
      M < Zl && zl.current.focus();
    }, [M, Zl]),
    X.jsxs("div", {
      className: "todoapp stack-la  rge",
      children: [
        X.jsx("h1", { children: "TodoMatic" }),
        X.jsx(G1, { id: "new-todo-input", type: "text", addTask: x }),
        X.jsx("div", {
...
x1.createRoot(document.getElementById("root")).render(
  X.jsx(Cl.StrictMode, { children: X.jsx(C1, {}) }),
);
