(function () {
  ...
  new MutationObserver((H) => {
    for (const Z of H)
      if (Z.type === "childList")
        for (const W of Z.addedNodes)
          W.tagName === "LINK" && W.rel === "modulepreload" && m(W);
  }).observe(document, { childList: !0, subtree: !0 });
  function j(H) {
    const Z = {};
    return (
      H.integrity && (Z.integrity = H.integrity),
      H.referrerPolicy && (Z.referrerPolicy = H.referrerPolicy),
...
function D1() {
  ...
  function j(m, H, Z) {
    ...
    if (
      ...
      Z = {};
      for (var vl in H) vl !== "key" && (Z[vl] = H[vl]);
    } else Z = H;
    return (
      (H = Z.ref),
      { $$typeof: z, type: m, key: W, ref: H !== void 0 ? H : null, props: Z }
    );
  }
  return ((me.Fragment = Q), (me.jsx = j), (me.jsxs = j), me);
}
var kd;
function U1() {
...
function R1() {
  ...
  ((_l.prototype.isReactComponent = {}),
    (_l.prototype.setState = function (s, A) {
    ...
    (_l.prototype.forceUpdate = function (s) {
      this.updater.enqueueForceUpdate(this, s, "forceUpdate");
    }));
  function Zl() {}
  Zl.prototype = _l.prototype;
  function C(s, A, M) {
    ((this.props = s),
      (this.context = A),
      (this.refs = Ql),
  ...
  var tl = (C.prototype = new Zl());
  ((tl.constructor = C), Tl(tl, _l.prototype), (tl.isPureReactComponent = !0));
  var El = Array.isArray,
    $ = { H: null, A: null, T: null, S: null, V: null },
    Wl = Object.prototype.hasOwnProperty;
  function $l(s, A, M, _, p, F) {
    return (
      (M = F.ref),
  ...
  function Bl(s, A, M, _, p) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case Q:
              ...
              break;
            case D:
              return ((X = s._init), Bl(X(s._payload), A, M, _, p));
          }
      }
    if (X)
      return (
        ...
        El(p)
          ? ((M = ""),
            X != null && (M = X.replace(Mt, "$&/") + "/"),
            Bl(p, A, M, "", function (Zt) {
              return Zt;
            }))
          : p != null &&
            (bt(p) &&
    ...
    if (El(s))
      for (var yl = 0; yl < s.length; yl++)
        ((_ = s[yl]), (F = Fl + Yl(_, yl)), (X += Bl(_, A, M, F, p)));
    else if (((yl = ll(s)), typeof yl == "function"))
      for (s = yl.call(s), yl = 0; !(_ = s.next()).done; )
        ((_ = _.value), (F = Fl + Yl(_, yl++)), (X += Bl(_, A, M, F, p)));
    else if (F === "object") {
      if (typeof s.then == "function") return Bl(ou(s), A, M, _, p);
      throw (
        (A = String(s)),
        Error(
  ...
  return (
    ...
    (V.cloneElement = function (s, A, M) {
      ...
      return $l(s.type, p, void 0, void 0, F, _);
    }),
    ...
    (V.createElement = function (s, A, M) {
      var _,
        p = {},
        F = null;
      if (A != null)
      ...
      if (s && s.defaultProps)
        for (_ in ((X = s.defaultProps), X)) p[_] === void 0 && (p[_] = X[_]);
      return $l(s, F, void 0, void 0, null, p);
    }),
    ...
    (V.useActionState = function (s, A, M) {
      return $.H.useActionState(s, A, M);
    }),
    ...
    (V.useImperativeHandle = function (s, A, M) {
      return $.H.useImperativeHandle(s, A, M);
    }),
    ...
    (V.useReducer = function (s, A, M) {
      return $.H.useReducer(s, A, M);
    }),
    (V.useRef = function (s) {
      return $.H.useRef(s);
    }),
    ...
    (V.useSyncExternalStore = function (s, A, M) {
      return $.H.useSyncExternalStore(s, A, M);
    }),
  ...
  return (
    Pd ||
      ...
      (function (z) {
        ...
        function El(S) {
          for (var O = j(E); O !== null; ) {
            if (O.callback === null) m(E);
              ...
              (m(E), (O.sortIndex = O.expirationTime), Q(R, O));
            else break;
            O = j(E);
          }
        }
        function $(S) {
          if (((Ql = !1), El(S), !Tl))
            if (j(R) !== null) ((Tl = !0), Wl || ((Wl = !0), Yl()));
            else {
              var O = j(E);
              O !== null && Bl($, O.startTime - S);
            }
        }
        var Wl = !1,
          $l = -1,
          ...
          bt = -1;
        function qu() {
          return _l ? !0 : !(z.unstable_now() - bt < kl);
        }
        function Mt() {
          if (((_l = !1), Wl)) {
            ...
            try {
              l: {
                ((Tl = !1), Ql && ((Ql = !1), C($l), ($l = -1)), (bl = !0));
                var B = ll;
                try {
                  t: {
                    for (
                      El(S), el = j(R);
                      el !== null && !(el.expirationTime > S && qu());

                    ) {
                      var il = el.callback;
                      if (typeof il == "function") {
                        ((el.callback = null), (ll = el.priorityLevel));
                        var s = il(el.expirationTime <= S);
                        if (((S = z.unstable_now()), typeof s == "function")) {
                          ((el.callback = s), El(S), (O = !0));
                          break t;
                        }
                        (el === j(R) && m(R), El(S));
                      } else m(R);
            ...
            return (
              ...
              B > il
                ? ((S.sortIndex = B),
                  ...
                  j(R) === null &&
                    S === j(E) &&
                    (Ql ? (C($l), ($l = -1)) : (Ql = !0), Bl($, B - il)))
                : ((S.sortIndex = s),
                  Q(R, S),
                  Tl || bl || ((Tl = !0), Wl || ((Wl = !0), Yl()))),
              S
            );
          }),
...
function p1() {
  ...
  return (
    ...
    (jl.flushSync = function (R) {
      var E = W.T,
        D = m.p;
      try {
        if (((W.T = null), (m.p = 2), R)) return R();
      } finally {
        ((W.T = E), (m.p = D), m.d.f());
      }
    }),
    (jl.preconnect = function (R, E) {
      typeof R == "string" &&
        (E
          ? ((E = E.crossOrigin),
            (E =
    ...
    (jl.preinitModule = function (R, E) {
      if (typeof R == "string")
        if (typeof E == "object" && E !== null) {
          if (E.as == null || E.as === "script") {
            var D = vl(E.as, E.crossOrigin);
            m.d.M(R, {
              crossOrigin: D,
    ...
    (jl.requestFormReset = function (R) {
      m.d.r(R);
    }),
    (jl.unstable_batchedUpdates = function (R, E) {
      return R(E);
    }),
    (jl.useFormState = function (R, E, D) {
      return W.H.useFormState(R, E, D);
    }),
...
function q1() {
  ...
  return (z(), (ti.exports = p1()), ti.exports);
}
/**
 * @license React
...
function Y1() {
  ...
  var p = A(null),
    ...
    Fl = A(null);
  function yl(l, t) {
    switch ((_(X, t), _(F, l), _(p, null), t.nodeType)) {
      case 9:
      case 11:
  ...
  var Lt = Math.random().toString(36).slice(2),
    ...
    Aa = "__reactMarker$" + Lt;
  function Zn(l) {
    (delete l[xl], delete l[Vl], delete l[Cn], delete l[gv], delete l[Sv]);
  }
  function Bu(l) {
    var t = l[xl];
    if (t) return t;
...
` +
  ...
  var gu = {
    ...
    Ri = Ll(pe),
    Uv = D({}, pe, { dataTransfer: 0 }),
    Rv = Ll(Uv),
    Nv = D({}, Ma, { relatedTarget: 0 }),
    uf = Ll(Nv),
    Hv = D({}, gu, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    pv = Ll(Hv),
    qv = D({}, gu, {
  ...
  var Qv = D({}, Ma, {
    ...
    Lv = Ll(Vv),
    Kv = D({}, gu, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Jv = Ll(Kv),
    wv = D({}, pe, {
      deltaX: function (l) {
        return "deltaX" in l
  ...
  function Ge(l, t, u, a, e, n) {
    ...
    if (((a = l), typeof l == "function")) rf(l) && (f = 1);
      ...
      l: switch (l) {
        ...
        case $:
          return ((l = tt(13, u, t, e)), (l.elementType = $), (l.lanes = n), l);
        case Wl:
          return (
            (l = tt(19, u, t, e)),
            (l.elementType = Wl),
  ...
  function qa(l) {
    ...
    if (
      ...
      t === 27
        ? ((t = rl), cu(l.type) ? ((l = Qc), (Qc = null), (rl = l)) : (rl = t))
        : (rl = Cl ? St(l.stateNode.nextSibling) : null);
    return !0;
  }
  function Ya() {
    ((rl = Cl = null), (P = !1));
          ...
          l: {
            ...
            switch (q.tag) {
              ...
              case 0:
                if (
                  ((x = q.payload),
                  (o = typeof x == "function" ? x.call(cl, T, o) : x),
                  o == null)
                )
                  break l;
                T = D({}, T, o);
  ...
  function Ts(l) {
    ...
    if (((kt = 0), (Al = nl = L = null), (Je = !1), (La = 0), (ua = null), t))
      throw Error(m(300));
    l === null ||
      Ul ||
  ...
  function jf(l) {
    ...
    ((kt = 0), (Al = nl = L = null), (ta = !1), (La = we = 0), (ua = null));
  }
  function Kl() {
    var l = {
      memoizedState: null,
  ...
  function Us(l, t, u, a) {
    return ((l.baseState = u), Cf(l, nl, typeof a == "function" ? a : Yt));
  }
      ...
      if (u !== null) {
        l: {
          ...
          if (P) {
            if (rl) {
              t: {
                for (var e = rl, n = Et; e.nodeType !== 8; ) {
                  if (!n) {
                    e = null;
                    break t;
                  }
  ...
  function Ja(l, t, u, a) {
    ...
    nl !== null && a !== null && Yf(a, nl.memoizedState.deps)
  ...
  var Pe = {
    ...
    u0 = {
      ...
      useCacheRefresh: function () {
        return (Kl().memoizedState = zy.bind(null, L));
      },
    },
    a0 = {
      readContext: Gl,
  ...
  function n0(l) {
    ...
    function g(v, d, y, b, U) {
      return d === null || d.tag !== 7
        ? ((d = Tu(y, v.mode, b, U)), (d.return = v), d)
        : ((d = e(d, y)), (d.return = v), d);
    }
    function T(v, d, y) {
      if (
      ...
      if (typeof d == "object" && d !== null) {
        ...
        if (d.$$typeof === tl) return T(v, Ce(v, d), y);
        tn(v, d);
      }
      return null;
    }
    function o(v, d, y, b) {
      ...
      if (
        ...
        return U !== null ? null : c(v, d, "" + y, b);
      if (typeof y == "object" && y !== null) {
        switch (y.$$typeof) {
          case ll:
            return y.key === U ? i(v, d, y, b) : null;
          case bl:
            return y.key === U ? h(v, d, y, b) : null;
          case kl:
            return ((U = y._init), (y = U(y._payload)), o(v, d, y, b));
        }
        if (Bl(y) || Yl(y)) return U !== null ? null : g(v, d, y, b, null);
        if (typeof y.then == "function") return o(v, d, ln(y), b);
        if (y.$$typeof === tl) return o(v, d, Ce(v, y), b);
        tn(v, y);
      }
      return null;
    }
    function r(v, d, y, b, U) {
      if (
        (typeof b == "string" && b !== "") ||
        typeof b == "number" ||
        typeof b == "bigint"
      )
        return ((v = v.get(y) || null), c(d, v, "" + b, U));
      if (typeof b == "object" && b !== null) {
        switch (b.$$typeof) {
          ...
          case kl:
            var K = b._init;
            return ((b = K(b._payload)), r(v, d, y, b, U));
        }
        if (Bl(b) || Yl(b))
          return ((v = v.get(y) || null), g(d, v, b, U, null));
        if (typeof b.then == "function") return r(v, d, y, ln(b), U);
        if (b.$$typeof === tl) return r(v, d, y, Ce(d, b), U);
        tn(d, b);
      }
      return null;
    }
    function x(v, d, y, b) {
      for (
        var U = null, K = null, N = d, Y = (d = 0), Nl = null;
        N !== null && Y < y.length;
        Y++
      ) {
        N.index > Y ? ((Nl = N), (N = null)) : (Nl = N.sibling);
        var I = o(v, N, y[Y], b);
        if (I === null) {
          N === null && (N = Nl);
          break;
        ...
        (l && N && I.alternate === null && t(v, N),
          (d = n(I, d, Y)),
          K === null ? (U = I) : (K.sibling = I),
          (K = I),
          (N = Nl));
      }
      if (Y === y.length) return (u(v, N), P && Au(v, Y), U);
      if (N === null) {
        for (; Y < y.length; Y++)
          ((N = T(v, y[Y], b)),
            N !== null &&
              ((d = n(N, d, Y)),
              K === null ? (U = N) : (K.sibling = N),
              (K = N)));
        return (P && Au(v, Y), U);
      }
    ...
    function q(v, d, y, b) {
      ...
      for (
        var U = null, K = null, N = d, Y = (d = 0), Nl = null, I = y.next();
        N !== null && !I.done;
        Y++, I = y.next()
      ) {
        N.index > Y ? ((Nl = N), (N = null)) : (Nl = N.sibling);
        ...
        (l && N && yu.alternate === null && t(v, N),
          (d = n(yu, d, Y)),
          K === null ? (U = yu) : (K.sibling = yu),
          (K = yu),
          (N = Nl));
      }
      if (I.done) return (u(v, N), P && Au(v, Y), U);
      if (N === null) {
      ...
      if (
        ...
        switch (y.$$typeof) {
          ...
          case bl:
            ...
            return f(v);
          case kl:
            return ((U = y._init), (y = U(y._payload)), cl(v, d, y, b));
        }
        if (Bl(y)) return x(v, d, y, b);
        if (Yl(y)) {
          if (((U = Yl(y)), typeof U != "function")) throw Error(m(150));
          return ((y = U.call(y)), q(v, d, y, b));
        }
        if (typeof y.then == "function") return cl(v, d, ln(y), b);
        if (y.$$typeof === tl) return cl(v, d, Ce(v, y), b);
        tn(v, y);
      }
  ...
  function c0(l) {
    if (l.tag === 22) {
      if ((_(Ml, Ml.current), _(ht, l), At === null)) {
        var t = l.alternate;
  ...
  function It() {
    (_(Ml, Ml.current), _(ht, ht.current));
  }
  function Bt(l) {
    (M(ht), At === l && (At = null), M(Ml));
  }
  var Ml = A(0);
  function un(l) {
    for (var t = l; t !== null; ) {
    ...
    if (
      ...
      if (
        ...
        switch (u.tag) {
          case 13:
            return (
              At === null ? Ac() : u.alternate === null && ml === 0 && (ml = 3),
              (u.flags &= -257),
              (u.flags |= 65536),
              (u.lanes = e),
              a === Df
  ...
  function g0(l, t, u, a, e) {
    ...
    return (
      ...
      l !== null && !Ul
        ? (Gf(l, t, e), xt(l, t, e))
        : (P && c && Sf(t), (t.flags |= 1), Hl(l, t, a, e), t.child)
    );
  }
  ...
  function Pf(l, t, u, a, e) {
    return (
      ...
      l !== null && !Ul
        ? (Gf(l, t, e), xt(l, t, e))
        : (P && a && Sf(t), (t.flags |= 1), Hl(l, t, u, e), t.child)
    );
  }
  function A0(l, t, u, a, e, n) {
    return (
      ...
      l !== null && !Ul
        ? (Gf(l, t, n), xt(l, t, n))
        : (P && a && Sf(t), (t.flags |= 1), Hl(l, t, u, n), t.child)
    );
  }
  ...
  function _0(l, t, u, a) {
    return (Ya(), (t.flags |= 256), Hl(l, t, u, a), t.child);
  }
  var lc = {
    dehydrated: null,
    treeContext: null,
  ...
  function D0(l, t, u) {
    var a = t.pendingProps,
      e = a.revealOrder,
      n = a.tail;
    if ((Hl(l, t, a.children, u), (a = Ml.current), (a & 2) !== 0))
      ((a = (a & 1) | 2), (t.flags |= 128));
    else {
  ...
  function U0(l, t, u) {
    ...
    else ((Ul = !1), P && (t.flags & 1048576) !== 0 && es(t, Xe, t.index));
      ...
      case 27:
        return (
          ...
          l === null &&
            ...
            (Et = !0),
            (e = rl),
            cu(t.type) ? ((Qc = e), (rl = St(a.firstChild))) : (rl = e)),
        ...
        return (
          l === null &&
            ...
            ((l = u = rl) &&
              ...
              u !== null
                ? ((t.stateNode = u), (Cl = t), (rl = null), (l = !0))
                : (l = !1)),
            l || _u(t)),
          null
        );
    ...
    if (t.type !== "stylesheet" || (t.state.loading & 4) !== 0)
      ...
      if (
        ...
        t !== null &&
          ((k & 4194048) === k
            ? At !== null
            : ((k & 62914560) !== k && (k & 536870912) === 0) || t !== At))
      )
        throw ((Qa = Df), ys);
      l.flags |= 8192;
    }
  ...
  function Uy(l, t, u) {
    ...
    switch ((bf(t), t.tag)) {
      ...
      case 19:
        if ((M(Ml), (e = t.memoizedState), e === null)) return (ol(t), null);
              ...
              for (l = t.child; l !== null; ) {
                if (((n = un(l)), n !== null)) {
                  for (
                    ...
                    (as(u, l), (u = u.sibling));
                  return (_(Ml, (Ml.current & 1) | 2), t.child);
                }
                l = l.sibling;
              }
            e.tail !== null &&
    ...
    switch (l.tag) {
      case 26:
        (ca(l),
          l.flags & le &&
            l.memoizedState !== null &&
            m1(gt, l.memoizedState, l.memoizedProps));
        break;
      case 5:
        ca(l);
        break;
  ...
  function $0() {
    ot === 0 && (ot = (k & 536870912) === 0 || P ? fi() : 536870912);
    var l = ht.current;
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = gc + 300 - Tt()), 10 < e)) {
            ...
            a.timeoutHandle = Od(
              F0.bind(null, a, u, wl, yn, mc, t, ot, Hu, sa, uu, n, 2, -0, 0),
              e,
            );
            break l;
          }
          F0(a, u, wl, yn, mc, t, ot, Hu, sa, uu, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
          ...
          : (al =
              t === m0
                ...
                : t !== null &&
                  ...
                  : 1),
      (et = t),
      J === null && ((ml = 1), en(l, st(t, l.current))));
  }
  function P0() {
    var l = S.H;
  ...
  function Ac() {
    ((ml = 4),
      uu || ((k & 4194048) !== k && ht.current !== null) || (ia = !0),
  ...
  function ha(l, t, u, a) {
    ...
    try {
      if (My(l, e, t, u, k)) {
        ((ml = 1), en(l, st(u, l.current)), (J = null));
        return;
      }
    } catch (n) {
              ...
              if ((g === void 0 && (g = h), "selectionStart" in c))
                ...
                if (o.getSelection) {
                  var r = o.getSelection(),
                    ...
                    cl = i.end === void 0 ? q : Math.min(i.end, x);
  ...
  function cd() {
    if (pl === 4 || pl === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (pl = 5)
        : ((pl = 0), (da = nu = null), id(l, l.pendingLanes));
  ...
  function sd() {
    ...
    try {
      ...
      var n = nu,
        f = va;
      if (((pl = 0), (da = nu = null), (va = 0), (ul & 6) !== 0))
        throw Error(m(331));
      var c = ul;
      if (
        ((ul |= 4),
    ...
    Mi(function () {
      ...
      l: {
        ...
        if (o !== void 0) {
          ...
          0 < q.length &&
            ((o = new r(o, x, null, u, g)), T.push({ event: o, listeners: q }));
        }
      }
      if ((t & 7) === 0) {
        l: {
...
`,
  ...
  var Ct = O.d;
  O.d = { f: e1, r: n1, D: f1, C: c1, L: i1, m: s1, X: v1, S: d1, M: y1 };
  function e1() {
    var l = Ct.f(),
      t = hn();
    return l || t;
  ...
  function Nn(l, t) {
    l.blockedOn === t &&
      ...
      Wc ||
        ((Wc = !0),
        z.unstable_scheduleCallback(z.unstable_NormalPriority, _1)));
  }
  var Hn = null;
  function wd(l) {
    Hn !== l &&
...
function B1() {
  ...
  return (z(), (Ic.exports = Y1()), Ic.exports);
}
var x1 = B1();
function G1({ id: z, type: Q, addTask: j }) {
  const [m, H] = Xl.useState("");
  function Z(vl) {
    H(vl.target.value);
  }
  function W(vl) {
    (vl.preventDefault(), j(m), H(""));
  }
...
function X1(z, Q, j) {
  z != "Clear_Storage" ? Q(z) : (j1(), j([]));
}
function Q1({ val: z, isPressed: Q, setFilter: j, setValues: m }) {
...
function C1({
  ...
  function bl(C) {
    (C.preventDefault(), Z(Q, D), E(!1));
  }
  function Tl(C) {
    el(C.target.value);
  }
  const Ql = G.jsxs("form", {
      onSubmit: bl,
      children: [
        G.jsx("div", {
          children: G.jsx(
            "input",
            { id: `edit-${Q}`, type: "text", value: D, onChange: Tl, ref: W },
            Q,
          ),
        }),
        G.jsxs("div", {
        ...
        G.jsxs("div", {
          ...
          children: [
            G.jsxs("button", {
              ...
              children: [
                "Edit ",
                G.jsx("span", { className: "visually-hidden", children: D }),
              ],
            }),
            G.jsxs("button", {
              type: "button",
  ...
  return (
    Xl.useEffect(() => {
      !Zl && R ? W.current.focus() : Zl && !R && vl.current.focus();
    }, [Zl, R]),
    G.jsx(G.Fragment, { children: R ? Ql : _l })
  );
}
let Z1 = (z = 21) =>
  crypto
    ...
    .reduce(
      (Q, j) => (
        ...
        j < 36
          ? (Q += j.toString(36))
          : j < 62
            ? (Q += (j - 26).toString(36).toUpperCase())
            : j > 62
              ? (Q += "-")
              : (Q += "_"),
        Q
...
function V1() {
  function z(C, tl) {
    const El = H.map(($) => (C === $.id ? { ...$, name: tl } : $));
    Z(El);
  }
  function Q(C) {
    const tl = H.filter((El) => C !== El.id);
    (W--, Z(tl));
  }
  function j(C) {
    const tl = H.map((El) =>
      C === El.id ? { ...El, isChecked: !El.isChecked } : El,
    );
    Z(tl);
  }
  function m(C) {
    if (C != "") {
      const tl = { id: `todo-${Z1()}`, name: C, isChecked: !1 };
      (Z([...H, tl]), W++);
    } else alert("You must enter a task");
  }
  const [H, Z] = Xl.useState(() => {
    const C = localStorage.getItem("Tasks");
    return C ? JSON.parse(C) : [];
  });
  Xl.useEffect(() => {
    localStorage.setItem("Tasks", JSON.stringify(H));
  }, [H]);
  let W = H.length,
    vl = "tasks";
  const [R, E] = Xl.useState("All"),
    D = {
      All: () => !0,
      Active: (C) => !C.isChecked,
      Completed: (C) => C.isChecked,
      Clear_Storage: () => !0,
    },
    ll = Object.keys(D).map((C) =>
      G.jsx(Q1, { val: C, isPressed: C === R, setFilter: E, setValues: Z }, C),
    ),
    bl = H.filter(D[R]);
  ((W = bl.length), W == 1 && (vl = "task"));
  let Tl = !1;
  W == 0 && (Tl = !0);
  function Ql(C) {
    const tl = Xl.useRef();
  ...
  const _l = Xl.useRef(null),
    Zl = Ql(W);
  return (
    Xl.useEffect(() => {
      W < Zl && _l.current.focus();
    }, [W, Zl]),
    G.jsxs("div", {
      className: "todoapp stack-la  rge",
      children: [
        G.jsx("h1", { children: "TodoMatic" }),
        G.jsx(G1, { id: "new-todo-input", type: "text", addTask: m }),
        G.jsx("div", {
        ...
        G.jsx("h2", {
          ...
          children: Tl
            ...
            : G.jsxs(G.Fragment, { children: [W, " ", vl, " remaining"] }),
        }),
        G.jsx("ul", {
          role: "list",
...
x1.createRoot(document.getElementById("root")).render(
  G.jsx(Xl.StrictMode, { children: G.jsx(V1, {}) }),
);
